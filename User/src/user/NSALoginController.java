package user;/*	Note that we're not using wildcards in our import statements like:
...
* Java's built-in {@link Math} class.
* <p>
...
public final class NSALoginController {
	...
	*/
	public static void hashUserPassword(User user) throws Exception {
        ...
        {
            throw new WeakPassword("Password is too weak. Please enter atleast 8 characters");
        }
